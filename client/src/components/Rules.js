function Rules() {
  ...
  return (
      <div className="rules-container">
        ...
        <p>If the player ends up on a blue square, you will receive a Customer Card and if you end up on an orange square, you will receive a Daily StandUp card. These cards contain one of two things:</p>
      ...
      <p>When the player ends up on Day of Illness, one or more people in the team become ill. Depending on how many and how long they are gone, Velocity lowers for X number of dice rolls.</p>
      <p>
